...
import { mdiContentSaveOutline , mdiSourceBranch } from "@mdi/js";
import { DrawerUpdateFiliereType } from '../../types/global';
...
export default function DrawerUpdate({open,closeDrawer,idUser} : DrawerUpdateFiliereType){
    ...
    return <>
        <Drawer BackdropProps={{ invisible: false }} className="min-w-[50%]" open={open} onClose={closeDrawer}>
            <ContainerProvider  className="mx-3 mt-2" title={Majors('Edit_Majors_Information_Form')}>
