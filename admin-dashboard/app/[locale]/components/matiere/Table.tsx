...
import { EnseignantType, MatiereType, TableEnseignantType, TableMatiereType } from '../../types/global';
...
const rows : MatiereType[] = [
  { nom : 'hamza ouadoud' ,filiere : 'Genie informatique' },
  { nom : 'hamza ouadoud' ,filiere : 'Genie informatique' },
  { nom : 'kamal ouadoud' ,filiere : 'Genie informatique' },
  { nom : 'hamza oudaoud' ,filiere : 'Genie informatique' },
];

export default function TableEns({openDrawerUpdate} : TableMatiereType) {
  ...
  const columns: readonly Column[] = [
    { id: 'nom', label: Subject('name'), minWidth: 170 },
    { id: 'filiere', label: Subject('majors'), minWidth: 100 },
    {
      id: 'action',
      label: 'action',
      minWidth: 200,
                        ...
                        return (
                            ...
                            {column.id !== 'action' ? (
                                ...
                                <TableCell key={`${row.nom}-edit`} className="flex items-center space-x-2 " align="left">
                                  ...
                                  <Popconfirm
                                    title={Subject('Remove_subject')}
                                    description={Subject('are_you_sure_?')}
                                    okText={Subject('yes')}
