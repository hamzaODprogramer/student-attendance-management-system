...
import { EnseignantType, TableEnseignantType } from '../../types/global';
...
const rows : EnseignantType[] = [
  { nom : 'hamza aoudoud' , cin :'HA241722' , email:'hamzaouadoud116@gmail.com' , telephone :'068212547' },
  { nom : 'hamza aoudoud' , cin :'HA241722' , email:'hamzaouadoud116@gmail.com' , telephone :'068212547' },
  { nom : 'kamal aoudoud' , cin :'HA241722' , email:'hamzaouadoud116@gmail.com' , telephone :'068212547' },
  { nom : 'hamza aoudoud' , cin :'HA241722' , email:'hamzaouadoud116@gmail.com' , telephone :'068212547' },
];

export default function TableEns({openDrawerUpdate,openDrawerInfo,openDrawerAuth} : TableEnseignantType) {
 
  const Teacher = useTranslations('Teacher')


  const columns: readonly Column[] = [
    { id: 'nom', label: Teacher('name') , minWidth: 170 },
                        ...
                        return (
                            ...
                            {column.id !== 'action' ? (
                                ...
                                <TableCell key={`${row.nom}-edit`} className="flex items-center space-x-2 " align="left">
                                  ...
                                  <Popconfirm
                                    title={Teacher('Remove_teacher')}
                                    description={Teacher('are_you_sure_?')}
                                    okText={Teacher('yes')}
                                    cancelText={Teacher('no')}
                                  >
                                  ...
                                  <Tooltip title="modifier les information de compte" arrow> <span onClick={()=>openDrawerAuth()}><Icon className='cursor-pointer' color={"rgba(0,0,0,0.6)"} path={mdiAccountLockOutline} size={1} /></span></Tooltip>
                                </TableCell>
                            )}
                            </React.Fragment>
                        );
