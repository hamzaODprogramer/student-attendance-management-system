...
import { FormControl , InputLabel , MenuItem , Button, Drawer, InputAdornment, Select, TextField } from "@mui/material";
...
const DrawerUpdate = ({open,closeDrawer,idUser} : DrawerUpdateEnseignantType) =>  {
    ...
    return <>
        <Drawer className="min-w-[50%]" open={open} onClose={closeDrawer}>
            <ContainerProvider closer className="mx-3 mt-2" title={Student('Edit_Student_Information_Form')}>
