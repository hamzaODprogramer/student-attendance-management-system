...
import { mdiEmailOutline , mdiContentSaveOutline , mdiPhoneOutline, mdiTrayArrowUp , mdiCardAccountDetailsOutline , mdiAccountOutline, mdiBookOutline, mdiFormatListNumbered } from "@mdi/js";
import { DrawerAddEnseignantType, DrawerUpdateEnseignantType } from '../../types/global';
import { useState } from 'react';
import { useTranslations } from 'next-intl';

export default function DrawerUpdate({open,closeDrawer,idUser} : DrawerUpdateEnseignantType){
    ...
    return <>
        <Drawer BackdropProps={{ invisible: false }} className="min-w-[50%]" open={open} onClose={closeDrawer}>
            <ContainerProvider  className="mx-3 mt-2" title={Classe('Edit_Classe_Information_Form')}>
